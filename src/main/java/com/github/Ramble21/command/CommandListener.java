        ...
        commandData.add(Commands.slash("messageguessr", "Guess which server member said a given message!")
                .addSubcommands(
                        new SubcommandData("configure-misc", "[ADMIN] Configure miscellaneous Messageguessr settings").addOptions(
                                ...
                                (new OptionData(OptionType.INTEGER, "num-wrong-answers", "Number of wrong answers included in each game (1-4)").setRequired(false)),
        ...
        commandData.add(
                Commands.slash("gd", "Geometry Dash-related commands")
                        ...
                        .addSubcommands(
                                ...
                                new SubcommandData("refresh", "[Moderator only] Refresh in-game and GDDL ratings for all submitted levels")
                                        .addOption(OptionType.BOOLEAN, "onlynulls", "Only refresh bugged levels with null difficulty (faster)", false),
